...
class AddApiToken extends React.Component {
  ...
  render () {
    ...
    const { message, messageOk, redirect, submitting, form, showToken, createdToken } = this.state;
    if (redirect) {
        ...
        {showToken
          ? (
            ...
            <div className="content-section">
              <ul>
                <li>This is the token that is required to talk to Karmen API</li>
                <li>It has to be used with every API request in the Authorization header like this <code>Authorization: Bearer &lt;token&gt;</code></li>
                <li>This token also does not have an expiration date and can be used forever</li>
                <li>If you need to disable it, you have to revoke it on the User preferences screen</li>
                <li>This token is not authorized to modify your password and cannot be used for administrative tasks like user management</li>
                <li><strong>You will never see this token again, so be sure that you have a secure copy of it</strong></li>
              </ul>
            ...
            <form>
              ...
              <div className="form-actions">
                <button type="submit" onClick={this.addApiToken} disabled={submitting}>Create token</button>
