...
class DiscoverPrintersTest(unittest.TestCase):
    ...
    @mock.patch(
        "server.tasks.discover_printers.get_avahi_hostname",
    ...
    def test_deactivate_unfound_printers(
        self,
        mock_delay,
        mock_update_printer,
        mock_avahi,
    ...
    @mock.patch("server.database.settings.get_val")
    @mock.patch(
        "server.tasks.discover_printers.do_arp_scan",
        return_value=[
    ...
    @mock.patch(
        "server.database.network_devices.get_network_devices",
        return_value=[
            {
                "ip": "172.17.0.2",
    ...
    def test_skip_device_ip(
        ...
        self.assertEqual(mock_update_printer.call_count, 1)
        mock_delay.assert_has_calls([mock.call("router.asus.com", "192.168.1.1")])
    ...
    @mock.patch("server.database.printers.update_printer")
    @mock.patch("server.tasks.discover_printers.sniff_printer.delay")
    def test_do_nothing_when_discovery_off(
        self,
        mock_delay,
        mock_update_printer,
        mock_avahi,
