...
insert into public.users (site_id, uuid, username, role, providers, providers_data)
  values (0, '6480fa7d-ce18-4ae2-818b-f1d200050806', 'test-admin', 'admin', '{"local"}', '{}')
...
insert into public.users (site_id, uuid, username, role, providers, providers_data)
  values (0, '77315957-8ebb-4a44-976c-758dbf28bb9f', 'test-user', 'user', '{"local"}', '{}')
  on conflict do nothing;
...
insert into public.users (site_id, uuid, username, role, providers, providers_data)
  values (0, 'e076b705-a484-4d24-844d-02594ac40b12', 'test-user-2', 'user', '{"local"}', '{}')
  on conflict do nothing;
