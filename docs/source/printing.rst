...
`Slic3r <https://slic3r.org/>`_ or `Cura <https://ultimaker.com/software/ultimaker-cura>`_?
You can use your slicer with Karmen as well. As long as your slicer can integrate with
`Octoprint <https://octoprint.org>`_.

Karmen is mimicking Octoprint's API that the slicers are calling. By setting up the address
of the printer in the slicer to something like ``http://<karmen IP address>:8080/octoprint-emulator``,
you can emulate Octoprint and send your G-Codes directly to Karmen. 
